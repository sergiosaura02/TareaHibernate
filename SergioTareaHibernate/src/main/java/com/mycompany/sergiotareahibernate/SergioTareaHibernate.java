            ...
            switch (menu) {
                ...
                case 2 -> {
                    ...
                    switch (numPulsadoCase2) {
                        ...
                        case 3 -> {
                            ...
                            LocalDate fechaSolicitud = introducirFecha("Introduce la fecha de solicitud con el formato dd/MM/yyyy");

                            alumnoCandidatoPracticaDAOImpl.save(new AlumnoCandidatoPractica(id, fechaSolicitud));
                        }
                        default ->
                            salirMenuPrincipal = true;
                    }
                ...
                case 3 -> {
                    ...
                    switch (numPulsadoCase3) {
                        ...
                        case 2 -> {
                            LocalDate fechaInicio = introducirFecha("Introduce la fecha de inicio con el formato dd/MM/yyyy");
                            ...
                            System.out.println("Introduce el ID del alumno de la practica:");
                            Alumno alumno = alumnoDAOImpl.findOneById(sc.nextInt());
                            sc.nextLine();

                            practicaDAOImpl.save(new Practica(fechaInicio, fechaFin, descripcion, empresa, alumno));
                ...
                case 4 -> {
                    ...
                    switch (numPulsadoCase4) {
                        ...
                        case 2 -> {
                            System.out.println("Introduce el sector sin tildes:");
                        ...
                        case 3 ->{
                            ...
                            System.out.println("Introduce el sector dela empresa:");
